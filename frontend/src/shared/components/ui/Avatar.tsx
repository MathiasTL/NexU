...
export const Avatar = ({ src, alt = '', size = 'md', className }: AvatarProps) => (
  src
    ...
    : <div className={cn('flex items-center justify-center rounded-full bg-primary-100 font-semibold text-primary-600', sizes[size], className)}>{alt.charAt(0).toUpperCase()}</div>
)
